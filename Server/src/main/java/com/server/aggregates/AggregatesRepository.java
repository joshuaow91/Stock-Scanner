...
public interface AggregatesRepository extends JpaRepository<Aggregates, Long> {
    ...
    List<Aggregates> findTop5ByStockSymbolAndTimeframeOrderByStartTimeDesc(@Param("stockSymbol") StocksEnums stockSymbol, @Param("timeframe") TimeframeEnums timeframe);
    ...
    List<Aggregates> findTop15ByStockSymbolAndTimeframeOrderByStartTimeDesc(@Param("stockSymbol") StocksEnums stockSymbol, @Param("timeframe") TimeframeEnums timeframe);
    ...
    List<Aggregates> findTop30ByStockSymbolAndTimeframeOrderByStartTimeDesc(@Param("stockSymbol") StocksEnums stockSymbol, @Param("timeframe") TimeframeEnums timeframe);
    ...
    List<Aggregates> findTop60ByStockSymbolAndTimeframeOrderByStartTimeDesc(@Param("stockSymbol") StocksEnums stockSymbol, @Param("timeframe") TimeframeEnums timeframe);
    ...
    List<Aggregates> findTop390ByStockSymbolAndTimeframeOrderByStartTimeDesc(@Param("stockSymbol") StocksEnums stockSymbol, @Param("timeframe") TimeframeEnums timeframe);
}
