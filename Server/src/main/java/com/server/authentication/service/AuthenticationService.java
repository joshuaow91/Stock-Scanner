...
public class AuthenticationService {
    ...
    public AuthenticationService(UserRepository repository, TokenService tokenService, CookieService cookieService, AuthenticationManager authenticationManager) {
